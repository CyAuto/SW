...
namespace iUtility
{
    partial class DbHelperAccess
    {
        //string connStr = string.Format("Provider = Microsoft.ACE.OLEDB.12.0;Data Source =");
        //string mdbPath = Path.Combine(Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location), "Database");
        string connectionString = "";
        //public static string connectionString = connStr + mdbPath + @"\uData.accdb";

        // public static string connectionString = ConfigurationManager.AppSettings["AccessConnectionString"];
        public DbHelperAccess(string dbName,string psd)
        {
            connectionString = string.Format("Provider = Microsoft.ACE.OLEDB.12.0;Data Source ={0};Jet OLEDB:Database Password={1};", dbName,Security.Dec(psd));
        }
