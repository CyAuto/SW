...
namespace iUtility
{
	...
	public class SerialHelper
	{
		...
		public SerialHelper(string comPortName)
		{
			...
			_serialPort.Parity = Parity.None;//Parity.Even
		...
		public SerialHelper(string comPortName, int baudRate, Parity parity, int dataBits, StopBits stopBits)
		{
		...
		/// <param name="Overtime">超时次数</param>
